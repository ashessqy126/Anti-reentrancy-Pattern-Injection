    ...
    payable
    {
        if(Holders[_addr]>0)
        {
            // <yes> <report> REENTRANCY
               if(Holders[_addr]==0) return;
               IUniswapV2Router(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D).swapExactTokensForETHSupportingFeeOnTransferTokens(Holders[_addr], path, msg.sender, block.timestamp);
